...
def CheckWinner():
    ...
    if winner ==1:
        messagebox.showinfo(title="おめでとうございます!", 
            message="学生 A の勝ちです!! ٩(๑❛ᴗ❛๑)۶")
    elif winner ==2:
        messagebox.showinfo(title="おめでとうございます!", 
            message="学生 B の勝ちです!! ٩(๑❛ᴗ❛๑)۶")
    elif mov ==9:
        messagebox.showinfo(title="(=´∀｀)人(´∀｀=)", 
            message="引き分けでした!!")
...
Button(text="開始", font=('Papyrus', 24, 'bold'), bg='Blue', fg='white',
